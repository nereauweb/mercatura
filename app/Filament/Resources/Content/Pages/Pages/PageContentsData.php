...
{
    private const FILTER_KEYS = ['filter_categories', 'filter_attributes', 'filter_created_after', 'filter_products', 'filter_sale', 'filter_bestseller', 'filter_green', 'filter_promo', 'filter_new'];
    ...
    public static function fill(Page $page, array $data): array
    {
        ...
        foreach (['sale', 'bestseller', 'green', 'promo', 'new'] as $flag) {
