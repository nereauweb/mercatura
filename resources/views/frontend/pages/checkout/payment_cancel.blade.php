{{-- @mercatura-view frontend.pages.checkout.payment_cancel @version 2 --}}
...
@section('content')
	<x-frontend::checkout.outcome :title="__('frontend.checkout.thanks_title')">
		<p>{{ __('frontend.checkout.payment_incomplete') }}</p>
		<p>{{ __('frontend.checkout.payment_complete_it') }}</p>
