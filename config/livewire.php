...
return [
    ...
    */
    ...
    // The storefront bundles Livewire with Vite (resources/js/app.js) and renders
    // @livewireScriptConfig; the admin panel injects the runtime through render hooks.
    'inject_assets' => false,
