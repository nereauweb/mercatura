...
return [
    ...
    */
    ...
    'custom' => [
        'consent_gdpr' => [
            ...
            'required' => 'Devi accettare l\'informativa sulla Privacy per continuare.',
        ],
        'consent_terms' => [
        ...
        'captcha' => [
            'failed' => 'La verifica di sicurezza non è riuscita. Riprova.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'bill_city' => 'Città di fatturazione',
        'bill_province' => 'Provincia di fatturazione',
        'bill_zip_code' => 'CAP di fatturazione',
        'bill_country' => 'Nazione di fatturazione',

        // Indirizzo di spedizione
        'ship_address' => 'Indirizzo di spedizione',
        'ship_city' => 'Città di spedizione',
        'ship_province' => 'Provincia di spedizione',
        'ship_zip_code' => 'CAP di spedizione',
        'ship_country' => 'Nazione di spedizione',

        // Preventivo (campi annidati customer.*)
        'customer.name' => 'Nome',
        'customer.surname' => 'Cognome',
        'customer.email' => 'Email',
        'customer.phone' => 'Telefono',
        'customer.company' => 'Ragione sociale',
        'customer.customer_type' => 'Forma giuridica',
        'customer.activity' => 'Settore di attività',
        'customer.vat_code' => 'Partita IVA',
        'customer.tax_code' => 'Codice fiscale',

        // Consensi
        'consent_gdpr' => 'Privacy',
        'consent_terms' => 'Termini e condizioni',
        'subscribe_newsletter' => 'Iscrizione newsletter',

        // Sicurezza
        'g-recaptcha-response' => 'Verifica di sicurezza',
        'captcha_token' => 'Verifica di sicurezza',
        'recaptcha' => 'Verifica di sicurezza',
        ...
        // Upload
        'image' => 'Immagine',
        'variant_image' => 'File di stampa',
        'print_file' => 'File di stampa',

        // Preventivo prodotto
        'new_product' => 'Articolo',
        'new_product.name' => 'Articolo',
        'new_product.quantity' => 'Quantità',
    ],
